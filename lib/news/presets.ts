...
export const newspaperPresets: NewspaperPreset[] = [
  ...
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.24, headlineScale: 0.9, colorTheme: "navy", paperColor: "newsprint", paperTone: 18, paperWeathering: true, showRules: false,
  ...
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.28, headlineScale: 1.15, colorTheme: "charcoal", paperColor: "white", paperTone: 8, paperWeathering: true, showRules: false,
  ...
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.42, headlineScale: 1.05, colorTheme: "forest", paperColor: "ivory", paperTone: 24, paperWeathering: true, showRules: false,
  ...
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.3, headlineScale: 1.2, colorTheme: "rust", paperColor: "white", paperTone: 12, paperWeathering: true, showRules: false,
      justifyText: false, showDropCaps: true,
    },
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.4, headlineScale: 1.02, colorTheme: "royal", paperColor: "ivory", paperTone: 28, paperWeathering: true, showRules: false,
      justifyText: true, showDropCaps: true,
    },
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.25, headlineScale: 1.22, colorTheme: "oxblood", paperColor: "newsprint", paperTone: 56, paperWeathering: true, showRules: false,
      justifyText: true, showDropCaps: false,
    },
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.22, headlineScale: 0.88, colorTheme: "olive", paperColor: "white", paperTone: 16, paperWeathering: true, showRules: false,
      justifyText: true, showDropCaps: false,
    },
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.34, headlineScale: 1.06, colorTheme: "plum", paperColor: "mist-gray", paperTone: 38, paperWeathering: true, showRules: false,
      justifyText: true, showDropCaps: true,
    },
  },
  {
    ...
    settings: {
      ...
      lineHeight: 1.34, headlineScale: 1.08, colorTheme: "sepia", paperColor: "parchment", paperTone: 72, paperWeathering: true, showRules: false,
      justifyText: false, showDropCaps: false,
    },
  },
];
...
export function applyNewspaperPreset(current: IssueSettings, id: NewspaperPresetId): IssueSettings {
  ...
  const identity = {
    newspaperName: current.newspaperName,
    motto: current.motto,
    publicationDate: current.publicationDate,
    dateline: current.dateline,
